...
public class GeneratePictureView extends FrameLayout{
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.generate_pic_layout,this);
        webView = (WebView) findViewById(R.id.smart_webView);
        ...
        webView.setWebViewClient(new WebViewClient(){
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
                ...
                for (String path:WebViewHelper.getInstence().getAllListPath()){
    ...
    public void changeDay(String strData,String userInfo,String userName,String other) {
        ...
        strData+="<br /><br />\n" +
                ...
                "<br />\n" +
                "<p style=\"color: orangered;font-size: x-small;text-align: center;letter-spacing: 0.5px;\">" +
                "由<strong>"+userName+"</strong>发送 "+other+"</p>";
